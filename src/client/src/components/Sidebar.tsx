...
export function Sidebar({ className, mobile = false, onNavigate }: SidebarProps) {
  ...
  const allLinks: NavLink[] = [
    ...
    { href: "/orders", label: "Orders", icon: ShoppingCart, roles: ["admin", "staff", "sales", "accountant", "accounts"] },
    ...
    { href: "/quotations", label: "Quotations and Estimate", icon: FileText, roles: ["admin", "staff", "sales", "accountant", "accounts"] },
    { href: "/finance", label: "Finance", icon: Banknote, roles: ["admin"] },
