...
from .routers import quotation_letters, proforma_invoices, product_price_list, customer_approved_rates
...
app.include_router(customer_approved_rates.router, tags=["Customer Approved Rates"])
